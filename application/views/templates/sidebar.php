    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Asia</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('admin/barang') ?>">
                    ...
                    <span style="font-size: 18px;">Barang</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('admin/kategori') ?>">
                    <i class="fas fa-fw fa-clipboard-list"></i>
                    <span style="font-size: 18px;">Kategori</span></a>
            </li>
            <!-- Nav Item - Dashboard -->
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('auth/logout') ?>">
                    ...
                    <span style="font-size: 18px;">Sign Out</span></a>
            </li>
